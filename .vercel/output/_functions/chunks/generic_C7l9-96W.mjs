...
import { A as maybeRenderHead, L as unescapeHTML, M as addAttribute, c as createConsoleLogger, gt as joinPaths, ht as isRemotePath, k as renderTemplate, x as spreadAttributes, yt as removeQueryString, z as createAstro } from "./sequence_BGeKp411.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_C2MAlrC7.mjs").catch((e) => {
