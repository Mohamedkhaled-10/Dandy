...
import { A as maybeRenderHead, B as createAstro, M as addAttribute, R as unescapeHTML, _t as joinPaths, bt as removeQueryString, c as createConsoleLogger, gt as isRemotePath, k as renderTemplate, x as spreadAttributes } from "./sequence_lUswI9jr.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_B4U60WSS.mjs").catch((e) => {
